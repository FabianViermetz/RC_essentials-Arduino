...
void serial_write(uint8_t port, byte data);                   // writes bytes to a specific ports buffer
void serial_activate(uint8_t port);                           // activates TX - required after serial_write() !
